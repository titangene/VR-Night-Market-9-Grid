...
namespace GcVR {
    public class GcVR_Gaze : MonoBehaviour {
        /// <summary>
        ...
        /// 自訂 Gaze 範圍，預設 2.8f
        /// </summary>
        public float DistanceRange = 2.35f;
        ...
        public GcVR_Delegate OnChange = delegate { };
        public GcVR_Delegate OnStare = delegate { };
        ...
        private void CreateGaze() {
            ...
            // 開啟 / 關閉目標物件之 EventTrigger (商品、放置之購物籃)
            ChangeTargetEventTrigger("Pro_Obj");
            //ChangeTargetEventTrigger("Basket_Placement_Area");
        }
        ...
        /// 目標物件名稱 是否 == ObjName
        /// </summary>
        public bool IsTargerObj_Name(string ObjName) {
            return GetObjName(currentObj_Infinity) == ObjName;
        }

        /// <summary>
        /// 目標物件 Tag 是否 == TagName
        /// </summary>
        public bool IsTargerObj_CheckTag(string TagName) {
            return currentObj_Infinity.tag == TagName;
        }
